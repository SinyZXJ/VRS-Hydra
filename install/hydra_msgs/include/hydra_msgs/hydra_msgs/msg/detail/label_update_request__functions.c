...
hydra_msgs__msg__LabelUpdateRequest__init(hydra_msgs__msg__LabelUpdateRequest * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    hydra_msgs__msg__LabelUpdateRequest__fini(msg);
    return false;
  }
  // updates
  if (!hydra_msgs__msg__NodeLabelUpdate__Sequence__init(&msg->updates, 0)) {
    hydra_msgs__msg__LabelUpdateRequest__fini(msg);
    return false;
  }
  return true;
...
hydra_msgs__msg__LabelUpdateRequest__fini(hydra_msgs__msg__LabelUpdateRequest * msg)
{
  ...
  // updates
  hydra_msgs__msg__NodeLabelUpdate__Sequence__fini(&msg->updates);
}
...
hydra_msgs__msg__LabelUpdateRequest__are_equal(const hydra_msgs__msg__LabelUpdateRequest * lhs, const hydra_msgs__msg__LabelUpdateRequest * rhs)
{
  ...
  // updates
  if (!hydra_msgs__msg__NodeLabelUpdate__Sequence__are_equal(
  ...
  hydra_msgs__msg__LabelUpdateRequest * output)
{
  ...
  // updates
  if (!hydra_msgs__msg__NodeLabelUpdate__Sequence__copy(
...
hydra_msgs__msg__LabelUpdateRequest__create(void)
{
  ...
  hydra_msgs__msg__LabelUpdateRequest * msg = (hydra_msgs__msg__LabelUpdateRequest *)allocator.allocate(sizeof(hydra_msgs__msg__LabelUpdateRequest), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(hydra_msgs__msg__LabelUpdateRequest));
  bool success = hydra_msgs__msg__LabelUpdateRequest__init(msg);
  if (!success) {
...
hydra_msgs__msg__LabelUpdateRequest__Sequence__init(hydra_msgs__msg__LabelUpdateRequest__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hydra_msgs__msg__LabelUpdateRequest * data = NULL;

  if (size) {
    data = (hydra_msgs__msg__LabelUpdateRequest *)allocator.zero_allocate(size, sizeof(hydra_msgs__msg__LabelUpdateRequest), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = hydra_msgs__msg__LabelUpdateRequest__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        hydra_msgs__msg__LabelUpdateRequest__fini(&data[i - 1]);
      }
...
hydra_msgs__msg__LabelUpdateRequest__Sequence__fini(hydra_msgs__msg__LabelUpdateRequest__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      hydra_msgs__msg__LabelUpdateRequest__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hydra_msgs__msg__LabelUpdateRequest__Sequence * array = (hydra_msgs__msg__LabelUpdateRequest__Sequence *)allocator.allocate(sizeof(hydra_msgs__msg__LabelUpdateRequest__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = hydra_msgs__msg__LabelUpdateRequest__Sequence__init(array, size);
  if (!success) {
...
hydra_msgs__msg__LabelUpdateRequest__Sequence__destroy(hydra_msgs__msg__LabelUpdateRequest__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    hydra_msgs__msg__LabelUpdateRequest__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
hydra_msgs__msg__LabelUpdateRequest__Sequence__are_equal(const hydra_msgs__msg__LabelUpdateRequest__Sequence * lhs, const hydra_msgs__msg__LabelUpdateRequest__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!hydra_msgs__msg__LabelUpdateRequest__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  hydra_msgs__msg__LabelUpdateRequest__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(hydra_msgs__msg__LabelUpdateRequest);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    hydra_msgs__msg__LabelUpdateRequest * data =
      (hydra_msgs__msg__LabelUpdateRequest *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!hydra_msgs__msg__LabelUpdateRequest__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          hydra_msgs__msg__LabelUpdateRequest__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!hydra_msgs__msg__LabelUpdateRequest__copy(
