...
#define NODE_MAIN_LOGGER_NAME "scene_graph_logger"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libhydra_ros.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<hydra::SceneGraphLogger>";
