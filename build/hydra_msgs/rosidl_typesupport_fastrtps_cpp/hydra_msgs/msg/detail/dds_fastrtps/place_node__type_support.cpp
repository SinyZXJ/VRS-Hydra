...
#include "hydra_msgs/msg/detail/place_node__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const hydra_msgs::msg::PlaceNode & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  hydra_msgs::msg::PlaceNode & ros_message)
{
  // Member: node_id
  cdr >> ros_message.node_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hydra_msgs::msg::PlaceNode;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const hydra_msgs::msg::PlaceNode *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hydra_msgs::msg::PlaceNode *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PlaceNode__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const hydra_msgs::msg::PlaceNode *>(
...
static size_t _PlaceNode__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PlaceNode(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _PlaceNode__callbacks = {
  "hydra_msgs::msg",
  "PlaceNode",
...
static rosidl_message_type_support_t _PlaceNode__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PlaceNode__callbacks,
...
{
  return &hydra_msgs::msg::typesupport_fastrtps_cpp::_PlaceNode__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hydra_msgs, msg, PlaceNode)() {
  return &hydra_msgs::msg::typesupport_fastrtps_cpp::_PlaceNode__handle;
}
